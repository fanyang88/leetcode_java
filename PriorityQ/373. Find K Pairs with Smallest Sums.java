...
/*
    ...
    poll=[1,2,0] res.add(1,2) index=0 point to nums2[0]=2   index++=1 offer[1,4,1]  Q=[7,2][1,4][11,2]
    poll=[1,4,1] res.add(1,4)  index=1 point to nums2[1]=4   index++=2 offer[1,6,2]  Q=[7,2][1,6][11,2]
